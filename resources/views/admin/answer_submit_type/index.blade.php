            ...
            <main>
                <div class="card shadow mb-12">
                    ...
                    <div class="box-header with-border col-12 text-center">
                        <h3 class="box-title">Answer Submit Type</h3>
                    </div>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>
                            Answer Submit Type List
                        </div>
                        <div class="card-body">

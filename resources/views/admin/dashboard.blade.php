                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-body"><canvas id="WlcAreaChart" width="100%" height="40"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-body"><canvas id="myPieChart" width="100%" height="40"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Sheba Group 2024</div>
                        {{-- <div>
...
@section('script')
    ...
    <script>
        ...
        // Multiline Area Chart Example
        var ctx = document.getElementById("WlcAreaChart");
        var myLineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHitRadius: 50,
                    pointBorderWidth: 2,
                    data: [8000, 25000, 21000, 14000, 15000, 22000, 25000, 27000, 20000, 19000, 29000,
                        30000, 33000
                    ],
                }],
            },
